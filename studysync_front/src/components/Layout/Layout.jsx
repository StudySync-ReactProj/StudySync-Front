 ...
 * 
 * Note: Global notifications are now rendered at the App level, so all routes
 * (including public routes like Login/Signup) have access to the notification system
 * 
 * @param {Object} props
